...
plugins. Re-runs agent discovery after installation to refresh KNOWN_AGENTS and
AGENT_ALIAS_MAP. AC: FR-11.1 through FR-11.6, AC-8.1 through AC-8.6
   ...
   - Step 8 — If user declines all suggestions: proceed with existing agent registry
