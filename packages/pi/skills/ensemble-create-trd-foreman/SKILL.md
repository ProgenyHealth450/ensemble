...
description: >-
  ...
  tables. All outputs are saved to docs/TRD/. Foreman subject contract: under
  --foreman, FOREMAN_TASK_TITLE and FOREMAN_TASK_DESCRIPTION carry the
  dispatched task's title and description (Foreman dispatch sets them; nothing
  else does). When FOREMAN_TASK_TITLE is set and non-empty the TRD must plan
  exactly that task, and you print the title you read before writing anything.
