...
> Comparison of [ensemble](https://github.com/Sunstone-Partners/ensemble) and [spec-kit](https://github.com/github/spec-kit) — two AI-assisted software development frameworks.
...
| Community plugin marketplace | ✅ open catalog | ❌ Sunstone-curated only |
...
Ensemble's marketplace is entirely Sunstone-authored with no mechanism for community extensions. spec-kit has an open community catalog with third-party contributions (Azure DevOps integration, archive extension) and documented extension development guides.
